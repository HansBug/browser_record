 ...
 */
if (typeof document.get_screenshot === 'undefined') {
    ...
    ***************************************************************************** */
                            ...
                            case 0:
                                ...
                                _loop_1 = function (backgroundImage) {
                                    var image, url, _c, path, x, y, width, height, pattern, _d, path, x, y, width,
                                        height, _e, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_1, pattern, _f,
                                        path, left, top_1, width, height, position, x, y, _g, rx, ry, radialGradient_1,
                                        midX, midY, f, invF;
        ...
        var renderElement = function (element, opts) {
            return __awaiter(void 0, void 0, void 0, function () {
                var ownerDocument, defaultView, resourceOptions, contextOptions, windowOptions, windowBounds, context,
                    ...
                    left, top, backgroundColor, renderOptions, canvas, renderer, root, renderer;
    ...
    let _screenshot_records = []

    function takeScreenshot() {
        html2canvas(document.body).then(function (canvas) {
            let imgData = canvas.toDataURL('image/png');
            _screenshot_records.push({
                time: getTimestamp(),
                uuid: generateUUID(),
                raw: imgData,
            })
    ...
    document.takeScreenshot = takeScreenshot;
